...
<body>
	...
	<table class="table text-center">
		...
		<tbody>
			<c:forEach items="${candidates}" var="candidates" varStatus="status">
			<tr>
				<td>${status.count}</td>
	...
	<table class="table text-center">
		...
		<tbody>
			...
			<tr>
				...
				<td><fmt:parseDate value="${bill.date}" pattern="yyyy-MM-dd" var="billDate"/>
					<fmt:formatDate value="${billDate}" pattern="yyyy년 M월 dd일"/>   
